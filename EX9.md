...
## WEKA:
<div align="justify"> Weka is a comprehensive software that lets you to preprocess the big data, apply different machine learning algorithms on big data and compare various outputs. This software makes it easy to work with big data and train a machine using machine learning algorithms. This tutorial will guide you in the use of WEKA for achieving all the above requirements. WEKA -an open source software provides tools for data preprocessing, implementation of several Data mining and Machine Learning algorithms, and visualization tools so that you can develop machine learning techniques and apply them to real-world data mining problems. What WEKA offers is summarized in the following diagram −
...
## PROCEDURE
1. Load the data file into the WEKA explorer. The data can be loaded from these sources − Local file system,Web,Database
...
6. Click on the Start button to start the classification process.The classification results would be presented on your screen as shown here−<br>
...
7. To see visual representation of the results,right click on the result in Result list box.Several options would pop up as shown here−<br>
